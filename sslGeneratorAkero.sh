...
rootCAServerCAAndClientCA(){
	...
	echo "Please give a file path to a directory you would like creating to save these certificates to. Must be full path e.g. /home/$USER/directoryforfiles"
    read -p "Directory: " directory
    while [ -z $directory ]
    do
    	echo "Please select a directory path"
    	read -p "Directory" directory
    done
    echo
